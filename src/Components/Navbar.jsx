  ...
  return (
    <nav className="bg-teal-900 h-14 px-4 md:px-10 flex items-center justify-between text-white w-full">
      ...
      <div className="flex items-center gap-4">
        <button>
          <img src={Search} alt="Search" className="h-5  opacity-80 hover:opacity-100 transition" />
        </button>
        <button>
          <img src={Theme} alt="Theme Toggle" className="h-5 opacity-80 hover:opacity-100 transition" />
        </button>
        <a
          href="#"
